...
public final class Robot extends GameEntity implements GameObject, Drawable, Updateable {
	...
	public Robot() throws SlickException {
		this("/data/Robots/Robot1.png", "Robot1", 15.5f, 200.0f,
				370.0f, 180.0f, new org.newdawn.slick.geom.Vector2f(150, 500), 1.0f, 25.0f, 75.0f);
	}

	Robot(String imageFile, String entityName, float radius, float viewRadius, float x, float y, Vector2f maxVelocity,float strength, float attackSpeed, float attackSkill)
